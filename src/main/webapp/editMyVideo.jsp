                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title" style="text-shadow: none;">Edit Video</div>
                        </div>
                        <div class="card-body">
                             <form action="update_videos" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-5">
									    <div class="form-group mt-2">
									 	...
									 	<div class="form-group mt-2">
									        <label>Category</label>
									         <input type="text" class="form-control" id="category" name="category" value="${videoCategory}" readonly>
									        <div class="row">
									            <div class="col-md-4">
									    ...
									    <div class="form-group mt-2">
									        ...
									        <textarea class="form-control" id="description" name="description" rows="4">${videoDescription}</textarea>
									    </div>
									    <div class="form-group mt-2">
			                                <label for="thumbnail">Thumbnail</label>
			                                <input type="file" class="form-control" id="thumbnail" name="thumbnail" value="${videoThumbnail }" accept="image/*">
			                                <div class="mt-2">
			                                    <p>Current Thumbnail:</p>
			                                    <c:if test="${not empty videoBase64Thumbnail}">
			                                        <img src="data:image/jpeg;base64,${videoBase64Thumbnail}" alt="Current Thumbnail" style="max-width: 100%;" class="rounded">
			                                    </c:if>
			                                </div>
			                            </div>
			                        </div>
                                    ...
                                    <!-- Video Section -->
				                        ...
				                        <div class="col-md-6 col-lg-7 d-flex justify-content-center align-items-center">
				                                ...
				                                <video id="videoPreview" class="w-100 h-100" controls>
				                                    <source src="${pageContext.request.contextPath}/assets/vid/${videoname}" id="videoSource" type="video/mp4">
