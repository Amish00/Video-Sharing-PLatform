    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
       ...
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #103cbe;">
           <div class="featured-image mb-3 mt-3 ">
            <img src="https://img.freepik.com/free-vector/mobile-encryption-concept-illustration_114360-5004.jpg?size=626&ext=jpg" class="img-fluid rounded" style="width: 250px;">
           </div>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Enter OTP" name="otp" required>
                </div>

                <div class="input-group mb-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6" type="submit">Verify OTP</button>
                </div>
                </form>
          </div>
       </div> 
