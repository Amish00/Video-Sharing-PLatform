        ...
        <div class="main-header">
          ...
          >
            <div class="container-fluid">
              ...
              >
                <form action="sortedExplore" method="get" class="navbar-left navbar-form nav-search">
				    <div class="input-group">
				        <input type="text" name="search" placeholder="Search ..." class="form-control" value="${param.search}">
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                >
                  <ul class="dropdown-menu dropdown-search animated fadeIn">
                   <form action="explore" method="get" class="navbar-left navbar-form nav-search">
				    <div class="input-group">
				        <input type="text" name="search" placeholder="Search ..." class="form-control" value="${param.search}">
				        <button type="submit" class="btn btn-search pe-1"><i class="fa fa-search search-icon"></i></button>
				    </div>
        ...
        <div class="container">
          <div class="page-inner">
		     ...
		     <div class="d-flex flex-wrap justify-content-center">
			    ...
			    <div class="card-car">
			        <a href="explore?category=all">
			            <img src="assets/img/car.jpg" class="d-block shadow rounded" alt="No image">
		            ...
		            <div class="container-fluid mt-4 flex-grow-1">
					    <div class="container my-2">
						    <div class="d-flex justify-content-between align-items-center">
						        <h3 class="mb-3">
						            <c:choose>
						                <c:when test="${selectedCategory == 'all'}">All Approved Videos</c:when>
						                <c:otherwise>${selectedCategory} Videos</c:otherwise>
						            </c:choose>
						        </h3>
						        <!-- Dropdown for sorting options -->
					            <form method="get" action="sortedExplore">
					                <div class="input-group mb-3">
					                    <select name="sortBy" class="form-select" onchange="this.form.submit()">
					                        <option value="relevant" <c:if test="${sortBy == 'relevant'}">selected</c:if>>Relevant</option>
					                        <option value="views" <c:if test="${sortBy == 'views'}">selected</c:if>>Views (Highest to Lowest)</option>
					                    </select>
						    ...
						    <div class="row">
						        <c:forEach var="video" items="${AllVideoData}">
						            <div class="col-md-4">
