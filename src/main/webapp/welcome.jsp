...
<body>
	...
	<!-- Welcome Section -->
	<section
		class="welcome-section d-flex align-items-center justify-content-center">
		<div class="welcome-content text-center">
			<!-- Logo -->
			<img src="assets/img/logo-light.svg" alt="VSP Logo" class="mb-4"
				style="width: 150px;">

			<!-- Welcome Note -->
			<h1 class="mb-3">Welcome to Virishare</h1>
			<p class="lead mb-5">Video Streaming Platform - Enjoy and explore
				endless content</p>
