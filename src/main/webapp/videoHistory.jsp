        ...
        <div class="container">
          <div class="page-inner">
				...
				<div class="container mt-3">
				    <h3 class="fw-bold mb-3">Your Video History</h3>
				    <div class="row">
				        <c:if test="${not empty videoHistoryList}">
				            <c:forEach var="video" items="${videoHistoryList}">
				                <div class="col-md-4 mb-3">
				                    <div class="card video-card">
				                        ...
				                        <c:if test="${empty video.base64Thumbnail}">
				                            <img src="assets/img/default-thumbnail.jpeg" alt="Default Thumbnail" class="card-img-top" />
				                        </c:if>
				
				                        <div class="card-body text-center">
				                            <h5 class="card-title">${video.title}</h5>
				                            <p class="card-text">${video.description}</p>
				                            <p class="card-text">Watched on: ${video.watchDate}</p>
				                            <a href="video?vid=${video.vid}" class="btn btn-primary">Watch Again</a>
				                        </div>
				                    </div>
				                </div>
				            </c:forEach>
				        ...
				        <c:if test="${empty videoHistoryList}">
				            <div class="col-12">
				                <p class="text-center">No videos in your history yet.</p>
				            </div>
				        </c:if>
				    </div>
				</div>
