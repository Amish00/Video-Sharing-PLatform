...
<body>
		...
		<div class="sidebar" data-background-color="dark">
			<div class="sidebar-logo">
				...
				<div class="logo-header" data-background-color="dark">
					<a href="dash" class="logo"> <img
						src="Admin/assets/img/logo-light.svg" alt="navbar brand"
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<ul class="nav nav-secondary">
						<li class="nav-item "><a href="dash"> <i
								class="fas fa-home"></i>
								<p>Dashboard</p>
						</a></li>
						<li class="nav-item active"><a data-bs-toggle="collapse"
							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									<ul class="nav nav-collapse">
										<li><a href="usertable"> <span class="sub-item">User
													Table</span>
										</a></li>
										<li><a href="approval"> <span class="sub-item">Approval
													Table</span>
										</a></li>
										<li><a href="videotable"> <span class="sub-item">Video
													Table</span>
										</a></li>
										<li><a href="history"> <span class="sub-item active">History
													Table</span>
										</a></li>
									</ul>
							</div></li>
		...
		<div class="main-panel">
			<div class="main-header">
				<div class="main-header-logo">
					<!-- Logo Header -->
					<div class="logo-header" data-background-color="dark">
						<a href="Admin/dashbash" class="logo"> <img
							src=".Adminassets/img/logo-light.svg" alt="navbar brand"
					...
					<div class="container-fluid">
						...
						<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
										...
										<div class="message-notif-scroll scrollbar-outer">
											<div class="notif-center">
												<a href="#">
													...
													<div class="notif-img">
														<img src="Admin/assets/img/chadengle.jpg"
															alt="Img Profile" />
													</div>
													<div class="notif-content">
							...
							<li class="nav-item topbar-icon dropdown hidden-caret"><a
								...
								role="button" data-bs-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <i
									class="fa fa-bell"></i> <span class="notification">4</span>
							</a>
								...
								href="#" aria-expanded="false">
									<div class="avatar-sm">
										...
										<c:if test="${empty loggedInUser.base64ProfilePhoto}">
											<img src="Admin/assets/img/profile.jpg" alt="Default Profile"
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div class="dropdown-user-scroll scrollbar-outer">
										...
										<li>
											...
											href="#">My Balance</a> <a class="dropdown-item"
											href="chartData">Inbox</a>
											<div class="dropdown-divider"></div> <a class="dropdown-item"
									...
									<div class="card-body">
										<form action="account" method="POST"
											...
											<div class="row">
												...
												<div class="col-md-7 col-lg-5">
													...
													<div class="form-group mt-2">
														<label for="email">Email Address</label> <input
															...
															value="${user.email}" readonly> <small
													...
													<div class="form-group mt-2">
														...
														<textarea class="form-control" id="bio" name="bio"
															rows="3" placeholder="Write a short bio">${user.bio}</textarea>
													</div>
													<div class="form-group mt-2">
														<label for="profilePhoto">Profile Photo</label> <input
															type="file" class="form-control" id="profilePhoto"
												...
												<!-- Picture Section -->
												<div
													class="col-md-1 col-lg-5 offset-lg-2 d-flex justify-content-center align-items-center flex-column">
													<!-- Add the "Current Thumbnail" label -->
													...
													<c:choose>
														<c:when test="${hasProfilePhoto}">
															...
															<img src="data:image/jpeg;base64,${profileImage}"
																alt="Profile Photo" class="img-fluid rounded shadow"
														...
														<c:otherwise>
															...
															<img
																...
																alt="Default Profile" class="img-fluid rounded shadow"
																style="width: 400px; height: 400px; object-fit: cover; border: 1px solid #ddd;">
														</c:otherwise>
													</c:choose>
												</div>
				...
				<div class="container-fluid d-flex justify-content-between">
					<nav class="pull-left">
						<ul class="nav">
							...
							<li class="nav-item"><a class="nav-link" href="#">Licenses</a>
							</li>
						</ul>
					</nav>
					<div class="copyright">
						<i class="fa fa-copyright"></i> 2024 Virishare. All Rights
						Reserved.
					</div>
				</div>
			</footer>
	...
	<!-- jQuery Scrollbar -->
	<script
		src="Admin/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>
	<!-- Datatables -->
