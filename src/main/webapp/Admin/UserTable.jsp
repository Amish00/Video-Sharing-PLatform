  ...
  <body>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">
                        <span class="fw-mediumbold"> All User Data </span>
                      </h4>
                      <button
                  ...
                  <div class="card-body">
					...
					<%List<User> uList = (List<User>)request.getAttribute("AllData"); %>
                      ...
                      >
				        ...
				        <% for (User u : uList) { %>
				            <tr>
				                ...
				                <td>
				                    <% if (u.getProfilePhotoBase64() != null && !u.getProfilePhotoBase64().isEmpty()) { %>
				                        <img src="data:image/jpeg;base64,<%= u.getProfilePhotoBase64() %>" class="img-fluid rounded" style="max-width: 100px;">
				                    <% } else { %>
				                        <img src="Admin/assets/img/nature1.jpeg" class="img-fluid" style="max-width: 100px;">
				                    <% } %>
				                </td>
						    ...
						    <form action="${pageContext.request.contextPath}/edit" method="post" style="display:inline;">
						        ...
						        <!-- You can include hidden inputs here to pass data to the editServlet -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      deleteModal.addEventListener('show.bs.modal', function(event) {
        ...
        var deleteUidInput = deleteModal.querySelector('#deleteUid');
        deleteUidInput.value = uid;
      });
    });

    $(document).ready(function () {
        window.togglePasswordVisibility = function () {
            console.log("Toggle Password Visibility triggered");
