      ...
      <div class="main-panel">
		...
		<div class="main-content">
          <div class="container mt-5 form-container"> <!-- Apply the form-container class here -->
            <h2 class="fw-mediumbold mt-5">Update Info</h2>
            <p>Update your data using this form, make sure you fill them all</p>
            <form id="addRowForm" method="post" action="${pageContext.request.contextPath}/update" enctype="multipart/form-data">
			...
			<% User u = (User) request.getAttribute("user"); %>
              <div class="row">
                <div class="col-sm-12">
			        <div class="form-group">
			            ...
			            <input id="addFirstName" type="text" class="form-control" placeholder="Enter first name" name="firstname" value="<%= u.getFirstName() %>" required />
			        </div>
			    </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Last Name</label>
                    <input id="addLastName" type="text" class="form-control" placeholder="Enter last name" name="lastname" value="<%= u.getLastName() %>" required />
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Phone Number</label>
                    <input id="addPhoneNumber" type="text" class="form-control" placeholder="Enter phone number" name="phonenumber"  value="<%= u.getPhoneNumber() %>" required />
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
              ...
              <div class="form-group">
                <label>Role</label>
                <select id="addRole" class="form-control" name="role" required>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="addUsername" type="text" class="form-control" placeholder="Enter username" name="username" value="<%= u.getUsername() %>" required />
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Email</label>
                    <input id="addEmail" type="email" class="form-control" placeholder="Enter email" name="email" value="<%= u.getEmail() %>" required />
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                ...
                <div class="col-sm-12">
		            <div class="form-group">
		                <label>Bio</label>
		                <textarea id="addBio" class="form-control" placeholder="Enter bio" name="bio"><%= u.getBio() %></textarea>
		            </div>
		        </div>
                <!-- Profile photo field -->
		        <div class="col-sm-12">
		            <div class="form-group">
		                ...
		                <input id="addProfilePhoto" type="file" class="form-control" name="profilepic" />
		            </div>
		        </div>
              </div>
              <button type="submit" id="addRowButton" class="btn btn-primary">Update</button>
				<input type="hidden" name="uid" value="<%= u.getUid() %>" /> <!-- Hidden input for UID -->

              <button type="button" class="btn btn-danger" onclick="window.location.href='usertable'">Cancel</button>
            </form>
          </div>
        </div>
      </div>
