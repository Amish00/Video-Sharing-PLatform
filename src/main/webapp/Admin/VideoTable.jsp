                ...
                <div class="collapse" id="tables">
                  <ul class="nav nav-collapse">
                   <li>
                    ...
                    <li>
                      <a href="videotable">
                        <span class="sub-item active">Video Table</span>
                      </a>
                    </li>
                    <li>
                      <a href="history">
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Video Table</h3>
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <c:forEach var="video" items="${AllVideoData}">
			                <tr>
			                    <td>${video.vid}</td>
			                     <td><img src="data:image/jpeg;base64,${video.base64Thumbnail}" class="img-fluid rounded" style="max-width: 150px;" alt="Thumbnail"></td>
			                    <td>${video.title}</td>
