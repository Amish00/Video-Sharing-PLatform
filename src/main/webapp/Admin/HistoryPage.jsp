  ...
  <body>
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">History Table</h3>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">All Viewed Videos</h4>
                  </div>
                  <div class="card-body">
    <div class="table-responsive">
        <table id="basic-datatables" class="display table table-striped table-hover">
            ...
            <tbody>
                <% 
                    List<History> historyList = (List<History>) request.getAttribute("historyData");
                    if (historyList != null && !historyList.isEmpty()) {
                        for (History history : historyList) {
                %>
                <tr>
                    <td><%= history.getHid() %></td>
                    <td><%= history.getUserFullName() %></td>
                    <td><%= history.getVideoTitle() %></td>
                    <td><%= history.getWatchDate() %></td>
                </tr>
                <% 
                        }
                    } else {
